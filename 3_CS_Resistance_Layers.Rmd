...
# Add a 200-m buffer
roads_NHS_buffer = buffer(roads_NHS,width = 400)
...
roads_PA_buffer <- buffer(roads_PA,width = 200)

## Combine NHS interstate and other highway spatial lines files
roads_buffer = gLineMerge(roads_NHS_buffer,roads_PA_buffer) 
...
writeRaster(roads_raster,"../R_output_files/transpo/roads_raster.tif",overwrite = R)
```
...
resistance_roads_nlcd <- cover(resistance_nlcd,roads_raster)
