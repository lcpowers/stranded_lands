...
canopy_mask[canopy_mask>100] <- 50
freq(canopy_mask)
...
writeRaster(resistance_mask,"../R_output_files/circuitscape/resistance/resistance_final.asc", format = "ascii",overwrite=T)
```
