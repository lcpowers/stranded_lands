...
center_ras = rasterize(pad_centroids, nlcd_mt, field = 1,background = NA)
NAvalue(center_ras) <- -9999
writeRaster(center_ras,"../R_output_files/circuitscape/center.asc",format = "ascii",overwrite=TRUE)
