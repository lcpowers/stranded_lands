...
# Resistance raster
res_ras <- raster("../R_output_files/circuitscape/resistance/resistance_FINAL_2.asc")
```
...
writeRaster(res_ras_gb,"../R_output_files/circuitscape/gb_resistance/gb_res_null.asc",format='ascii')
writeRaster(stranded_highRes,"../R_output_files/circuitscape/gb_resistance/gb_res_strandedHigh.asc",format = 'ascii')
writeRaster(stranded_modRes,"../R_output_files/circuitscape/gb_resistance/gb_res_strandedMod.asc",format = 'ascii')
writeRaster(stranded_lowRes,"../R_output_files/circuitscape/gb_resistance/gb_strandedLow.asc", format = 'ascii')
```
