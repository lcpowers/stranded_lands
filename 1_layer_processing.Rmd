...
# Raster: Lower 48 NLCD raster data
...
### 4. Crop NLCD to Montana outline, the resample to desired resolution
...
### 9. Crop MT NLCD to outline of GB Counties
```{r crop_mtNLCD_toGB}
