...
setwd("~/Desktop/StrandedLand/stranded_repo") # Sets working directory on my computer. This will need to be updated on anyone else's computer
```

### 2. Load Data
```{r load_data}

nlcd <- raster("./input_data/nlcd/NLCD_2016_Land_Cover_L48_20190424.img")
